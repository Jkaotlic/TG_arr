...
- [x] История поиска с возможностью быстрого повтора ✅ (quick_actions на /start)
...
#### Календарь релизов
- [x] Показ предстоящих релизов из Sonarr/Radarr ✅
- [x] Фильтрация по типу (фильмы/сериалы) ✅
- [x] Подписка на уведомления о выходе серий ✅
...
#### Dashboard
- [x] Базовая статистика на /start (поиски, скачивания, добавленное) ✅
- [x] Статус загрузок qBittorrent на главном экране ✅
...
- [x] Красивое форматирование с эмодзи ✅ (новый home screen)
- [x] Статистика пользователя на главном экране ✅
